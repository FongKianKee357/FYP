<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         <h3>follow us</h3>
         <a href="https://www.facebook.com/boutiquehandcraftmodelhouse/"><i class="fab fa-facebook-f"></i>facebook</a>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>Boutique Handcraft Model House</span> | all rights reserved!</div>
