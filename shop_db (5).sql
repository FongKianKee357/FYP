...
(3, 7, 'lowrenxing', '0175831405', 'lowrenxing2003@gmail.com', 'TNG eWallet', 'No. 7,jalan berlian, 4 taman berlian, 83700 Yong peng, , , , , ', 'Nendoroid 1861 Inugami Korone (86 x 3) - ', 258, '2024-06-04', 'pending');
...
CREATE TABLE `repass` (
  `Reset_passID` int(11) NOT NULL,
  `Reset_passEmail` text NOT NULL,
  `Reset_passSelector` text NOT NULL,
  `Reset_passToken` longtext NOT NULL,
  `Reset_passExpires` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `users` (
  ...
  `Reset_passToken` longtext DEFAULT NULL,
  `Reset_passExpires` text DEFAULT NULL,
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `address1`, `address2`, `address3`, `phoneNum`, `Reset_passToken`, `Reset_passExpires`, `verification_token`, `verification_expiry`) VALUES
(1, 'kiankee357', 'kiankee357@yahoo.com', '52cde7788bfc8c985eec58560040f294eca15b0b', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 'low', 'lowrenxing@gmail.com', '601f1889667efaebb33b8c12572835da3f027f78', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(5, 'kexin', 'xinke0202@gmail.com', '48d26a72adebe65089182c31b24fb1ccb24d8b0e', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(6, 'xin', 'kexin@gmail.com', '62becc49ca74c5a31e644661984635fa18d37a81', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(7, 'lowrenxing', 'lowrenxing2003@gmail.com', '24110c1d0d697d9f7123fa6d2d3e40ac55dd10d6', '7,jalan berlian, 4 taman berlian, 83700 Yong peng', 'C-12-05, MC Office, Ixora Apartment Melaka Tengah, Melaka, 75450', '', '0175831405', NULL, NULL, NULL, NULL),
(19, 'lowrenxing03', 'lowrenxing03@gmail.com', 'fa0c208897c5b217b1bb7ed4024417a71b7fa2e0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
ALTER TABLE `repass`
  MODIFY `Reset_passID` int(11) NOT NULL AUTO_INCREMENT;
